          ...
          <div class="form-group">
            <div class="utility">
              <div class="animated-checkbox">
                <label>
                  <input type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>><span class="label-text">Recordar sesión</span>
                </label>
              </div>
            ...
            <button class="btn btn-primary btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>Confirmar</button>
          </div>
          </div>
...
<?php /**PATH C:\Users\Néstor\Desktop\Foma\cloud_foma\resources\views/auth/login.blade.php ENDPATH**/ ?>